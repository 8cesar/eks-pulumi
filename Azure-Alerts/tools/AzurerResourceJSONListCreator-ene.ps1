 ...
 param(
    ...
    [string]
    $SubscriptionID = "3c9ecae3-4584-440f-b7cc-b2deb19f2d9c",
     
    [string]
    $SubscriptionName = "eneprod",
    ...
    $SQbMetrics = "cpu_percent",

    $SQLmonitname = "CPU percent",
                        
    $SQLoperator = "GreaterThan",
                      
    $SQLthreshold = 90,
                      
    $SQLtimeAggregation = "Average",
    ...
    $AppNameMetrics = "CpuPercentage",

    $AppNamemonitname = "CPU percent", 
